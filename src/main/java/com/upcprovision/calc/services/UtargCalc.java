...
@Service
public class UtargCalc {

    public double utargcalc(DealsDTO dealsDTO, int x) {
        BigDecimal p = BigDecimal.valueOf(0);                         //podstawa do mnozenia
        ...
        if (!loj) {                                                    //jezeli nie wystepuje lojalizacja p = 1/2 roznicy arpu
